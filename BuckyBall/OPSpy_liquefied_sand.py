...
class Ops_py_WangReese1998(OpsBasePYCurve):
...
class Ops_py_Rollins2005(OpsBasePYCurve):
    def __init__(self, soil: SaturatedSand, pile: BasePile):
        super().__init__(soil, pile)
...
class Ops_py_Frankehybr(OpsBasePYCurve):
    def __init__(self, soil: SaturatedSand, pile: BasePile):
        self.curve1 = Ops_py_Rollins2005(soil, pile)
        self.curve2 = Ops_py_WangReese1998(soil, pile)
    def calc_py(self, dp: float, y: float, z: float) -> float: 
